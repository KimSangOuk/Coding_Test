# 풀이시간 15분/30분 시간제한 1초 메모리제한 128MB
# 4회차 정답
# 현재의 무게에서 구할 수 있는 갯수에다가 나머지의 갯수를 곱해서 구하는 되는 그리디 문제.
...
# 3회차 풀이
# 2회차에서 풀 때는, 지금 상황에서 필요한 것만 고르는 아이디어를 염두해 두고 있었지만, 그 상황에서 필요한 것들을 표현으로 압축하는 것을 생각해내지 못함
